...
//local_cams Connection Class @-B894EB3C
class clsDBlocal_cams extends DB_Adapter
{
    function clsDBlocal_cams()
    {
        $this->Initialize();
    }
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["local_cams"]);
        parent::Initialize();
...
//End local_cams Connection Class
